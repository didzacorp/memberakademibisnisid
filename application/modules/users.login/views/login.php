    <div class="forny-img" style="position: absolute;z-index: 0; width: 100%;height: 100%;">
    </div>
    <div class="forny-container" style="position: absolute;z-index: 1;width: 100%;">
        ...
        <div class="forny-inner">
            <div class="forny-form">
                ...
                <div class="text-center">
                    <h4>Login Member</h4>
                    <p class="mb-10">Selamat Datang di, Akademi Bisnis</p>
                </div>
                <form action="post" id="loginForm" name="loginForm">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                 ...
                 <input required  class="form-control" name="email" id="email" type="email" placeholder="Email Address" 
                     onclick="blurBackground('blur(8px)');"
                     onkeyup="blurBackground('blur(8px)');"
                >
                ...
                <div class="input-group">
                 ...
                 >
                    ...
                    <div class="text-center mt-10">
                        <!-- Don't have an account? <a href="03_register.html">Register here</a> -->
                    </div>
                </form>
            </div>
        </div>
